...
int main() {
	...
	ew::Mesh planeMesh = ew::Mesh(ew::createPlane(12,12,32));
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindTextureUnit(0, waterTexture);
		...
		waterShader.setInt("water_texture", 0);
		waterShader.setFloat("time", time);
		waterShader.setFloat("wave_scale", 10.0f);
